...
var (
	...
	epyc_7502p_32_topology = &topology.CPUTopology{
		...
		CPUDetails: map[int]topology.CPUInfo{
			...
			4:  {CoreID: 4, SocketID: 0, UnCoreCacheID: 0},
			5:  {CoreID: 5, SocketID: 0, UnCoreCacheID: 0},
			6:  {CoreID: 6, SocketID: 0, UnCoreCacheID: 0},
			7:  {CoreID: 7, SocketID: 0, UnCoreCacheID: 0},
			8:  {CoreID: 8, SocketID: 0, UnCoreCacheID: 0},
			9:  {CoreID: 9, SocketID: 0, UnCoreCacheID: 0},
			10: {CoreID: 10, SocketID: 0, UnCoreCacheID: 0},
			11: {CoreID: 11, SocketID: 0, UnCoreCacheID: 0},
			12: {CoreID: 12, SocketID: 0, UnCoreCacheID: 0},
			13: {CoreID: 13, SocketID: 0, UnCoreCacheID: 0},
			14: {CoreID: 14, SocketID: 0, UnCoreCacheID: 0},
			15: {CoreID: 15, SocketID: 0, UnCoreCacheID: 0},
			16: {CoreID: 16, SocketID: 0, UnCoreCacheID: 0},
			17: {CoreID: 17, SocketID: 0, UnCoreCacheID: 0},
			18: {CoreID: 18, SocketID: 0, UnCoreCacheID: 0},
			19: {CoreID: 19, SocketID: 0, UnCoreCacheID: 0},
			20: {CoreID: 20, SocketID: 0, UnCoreCacheID: 0},
			21: {CoreID: 21, SocketID: 0, UnCoreCacheID: 0},
			22: {CoreID: 22, SocketID: 0, UnCoreCacheID: 0},
			23: {CoreID: 23, SocketID: 0, UnCoreCacheID: 0},
			24: {CoreID: 24, SocketID: 0, UnCoreCacheID: 0},
			25: {CoreID: 25, SocketID: 0, UnCoreCacheID: 0},
			26: {CoreID: 26, SocketID: 0, UnCoreCacheID: 0},
			27: {CoreID: 27, SocketID: 0, UnCoreCacheID: 0},
			28: {CoreID: 28, SocketID: 0, UnCoreCacheID: 0},
			29: {CoreID: 29, SocketID: 0, UnCoreCacheID: 0},
			30: {CoreID: 30, SocketID: 0, UnCoreCacheID: 0},
			31: {CoreID: 31, SocketID: 0, UnCoreCacheID: 0},
			32: {CoreID: 0, SocketID: 0, UnCoreCacheID: 1},
...
func TestTakeTopologyIterate(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			gold_5218_topology,
			[]int{1, 2, 3, 4},
			"map[1:0 2:1,4 3:32-33,36 4:8-9,12-13]",
		},
		{
			"epyc_7402p_topology",
			epyc_7402p_topology,
			[]int{1, 2, 3, 4},
			"map[1:0 2:24-25 3:1-3 4:26-29]",
		},
		{
			"epyc_7502p_32_topology",
			epyc_7502p_32_topology,
			[]int{2, 2, 2, 2},
			"map[1:0-1 2:32-33 3:2-3 4:34-35]",
		},
		{
			"epyc_7502p_32_topology_TAKE_BY_3",
			epyc_7502p_32_topology,
			[]int{3, 3, 3, 3},
			"map[1:0-2 2:32-34 3:3-5 4:35-37]",
		},
	}
